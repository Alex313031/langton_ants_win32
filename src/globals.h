...
extern volatile bool g_stopped; // True at startup (no animation has happened yet) and after IDM_STOP. Cleared the moment the simulation actually starts playing (ShowAnts / TogglePaintAnts unpause). Purely a label hint — chooses "Play" vs "Resume" on the toolbar's pause/play button.
